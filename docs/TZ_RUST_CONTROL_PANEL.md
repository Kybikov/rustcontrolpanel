...
- Player Intelligence Relations details now read paginated current `GET /players/:id/team-probability` and `GET /players/:id/team-evidence` data directly, keeping the detailed proof table fresh without adding a separate primary widget.
